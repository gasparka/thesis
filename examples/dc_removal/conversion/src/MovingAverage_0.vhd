-- generated by pyha 0.0.4 at 2017-04-01 20:01:43
library ieee;
...
package MovingAverage_0 is
    ...
    type next_t is record
        shift_register: sfixed0_17_list_t(0 to 31);
        sum: sfixed(5 downto -17);
...
package body MovingAverage_0 is
    ...
    begin
        ...
        -- calculate new sum
        self.\next\.sum := resize(self.sum + x - self.shift_register(self.shift_register'length-1), 5, -17, fixed_wrap, fixed_truncate);
